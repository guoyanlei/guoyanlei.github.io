...
更详细的介绍，请移步 https://yq.aliyun.com/articles/59373，这里只总结DataX在同步MySQL分库分表的使用。
...
从https://github.com/alibaba/DataX中下载源码编译，或直接下载已编译好的工具包。
    ...
    "content": [
      {
        ...
        "writer": {
          "name": "hdfswriter",
          "parameter": {
            "defaultFS": "hdfs://nn1.hadoop.bigdata.dmp.com:8020",
            "fileType": "orc",
...
```
具体的hdfs写入，参考（https://github.com/alibaba/DataX/blob/master/hdfswriter/doc/hdfswriter.md）
